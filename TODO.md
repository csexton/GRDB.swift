...
- [ ] Record.init(row:) should be the designated initializer, and Record.init() should call it. The goal is to have a single place where to put initialization code.
